...
CASE_ID = 'case_id'
# TESTRAIL_TESTCASE_ID = 'testrail_testcase_id'
...
# def testrail_testcase_id(id):
#     """Decorator that adds test case id to a test"""
#     def wrap_ob(ob):
#         setattr(ob, TESTRAIL_TESTCASE_ID, id)
#         return ob
#     return wrap_ob
    ...
    def stopTest(self, test):
        ...
        if test_case_id:
            with open_atomic('test.txt', 'w') as f:
                f.write('%s:%s,%d' % (test_name, test_method, test_case_id))
